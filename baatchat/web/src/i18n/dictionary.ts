...
export const dictionary = {
  ...
  "site.appearance.background": { en: "Background", it: "Sfondo", nb: "Bakgrunn" },
  "site.appearance.color": { en: "Colour", it: "Colore", nb: "Farge" },
  "site.background.bay": { en: "Bay", it: "Baia", nb: "Bukt" },
  "site.background.deepblue": { en: "Deep blue", it: "Blu profondo", nb: "Dyp blå" },
  "site.background.villages": { en: "Villages", it: "Villaggi", nb: "Landsbyer" },
  "site.background.scene": { en: "Scene", it: "Scena", nb: "Scene" },
  "site.color.pick": {
    en: "Choose colour {color}",
    it: "Scegli il colore {color}",
    nb: "Velg farge {color}",
  },
